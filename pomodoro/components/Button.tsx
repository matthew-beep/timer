...
export function Button({
  ...
  return (
    <button
      {...props}
      className={clsx(
        "font-medium transition-colors active:scale-95 select-none cursor-pointer",
        {
          ...
          "text-white/50 hover:bg-white/10 hover:text-white transition-all duration-150":variant === "plain",
        },
        className
      )}
    >

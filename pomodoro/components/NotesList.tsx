...
export default function NotesList() {
  ...
  return (
    ...
    <motion.div 
      className="top-0 right-0 absolute inset-0 z-10 w-24 h-full pointer-events-none bg-[#0a1929]/50 backdrop-blur-2xl border-l border-white/10"
      initial={{
        opacity: 0,
        x: -300,
      }}

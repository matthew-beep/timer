        ...
        <div className='flex items-center pr-5 h-10 gap-2'>
          ...
          <div className="relative bg-cardBg/60 p-1 rounded-full backdrop-blur-md border border-white/10 flex items-center h-10 w-24">
            ...
            <button
              ...
              className={`relative flex-1 flex justify-center items-center h-full z-10 transition-colors duration-200 ${viewMode === 'grid' ? 'text-active' : 'text-text/50 hover:text-text'
                }`}
            >
            ...
            <button
              ...
              className={`relative flex-1 flex justify-center items-center h-full z-10 transition-colors duration-200 ${viewMode === 'list' ? 'text-active' : 'text-text/50 hover:text-text'
                }`}
            >
              <LuList size={18} />
            </button>

...
export default function Home() {
  ...
  return (
      ...
      <div className="h-screen flex flex-col font-sans">
        <Header />
        <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 64 64" aria-hidden="true" role="img" className="iconify iconify--emojione" preserveAspectRatio="xMidYMid meet">
